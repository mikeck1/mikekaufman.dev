    ...
    return (
        <div>
            <Card style={{ marginBottom: "8px", position: "flex" }}>
                ...
                <Card.Body style={{ marginTop: "250px", padding: "20px" }}>
                    <ListGroup className="list-group-flush">
                        <ListGroupItem><Card.Title style={{ textAlign: "left", fontFamily: "monospace" }}><b>{titleLimited}</b></Card.Title></ListGroupItem>
                        <ListGroupItem>
